...
1. En el mismo orden en el que aparecen en la lista original
1. Ignorando los juguetes con cantidades no válidas (menores o iguales a 0, o que no sean número)
